		...
		<div id="layoutSidenav_content"> 
			<main>
	          <div class="container-fluid px-4">
	            <h1 class="mt-4">Formulario nueva atracción</h1>
	            <ol class="breadcrumb mb-4">
	              ...
	              <li class="breadcrumb-item active">Nueva Atraccion</li>
	            </ol>
	            ...
	            <div class="card mb-4">
	              ...
	              <div class="card-body">
					...
					<!--  Form -->
	                <form action="/visitatierramedia/admin/attractions/create.do" method="post" class="needs-validation" novalidate>
	                  <jsp:include page="/admin/attractions/form.jsp"></jsp:include>

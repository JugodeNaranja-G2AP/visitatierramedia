...
<link rel="shortcut icon"
	href="/visitatierramedia/assets/img/icons/loguitoICO.ico">
...
<script defer
	src="/visitatierramedia/vendors/bootstrap/js/bootstrap.bundle.min.js"></script>
<script type="text/javascript"
	src="/visitatierramedia/assets/js/custom.js" defer></script>
...
<body>
	<header class="header">
		<!--  Navbar -->
		<nav
			class="navbar navbar-expand-md navbar-light navbar-transp fixed-top bgcolor"
			aria-label="Fourth navbar example">
			<div class="container">
				<a class="navbar-brand" href="#"> <img class="logo"
					src="/visitatierramedia/assets/img/logos/logo-blanco-oro.png"
					alt="" width=190px />
				</a>
				...
				<div class="navbar-collapse collapse" id="navbarsExample04">
					<ul class="navbar-nav me-auto mb-2 mb-md-0">
						<li class="nav-item"><a class="nav-link nav-text fs-4 "
							aria-current="page" href="/visitatierramedia/index.jsp">Inicio</a>
						</li>
						<li class="nav-item"><a class="nav-link nav-text fs-4 "
						...
						<li class="nav-item"><c:choose>
								...
								<c:otherwise>
									...
									<a class="nav-link nav-text fs-4" type="button"
										data-bs-toggle="modal" data-bs-target="#loginModal">Ofertas</a>
								</c:otherwise>
							</c:choose></li>
					</ul>
						...
						<c:when test="${usuario != null}">
							...
							<div class="btn-group">
								<button type="button"
									...
									<img src='<c:out value="${usuario.imagen}"></c:out>'
										id="fotoPerfil" alt="foto perfil"
								...
								<ul class="dropdown-menu dropdown-menu-end">
									<li><a class="dropdown-item "
										href="/visitatierramedia/purchased.do" aria-current="true">
											<img class="pb-2 pe-1"
									...
									<li><a class="dropdown-item"
										href="/visitatierramedia/logout"> <img class="pb-1 pe-1"
										...
										<form action="login" method="post">
											<div class="form-floating mb-3">
												<input class="form-control" id="inputNombre" type="text"
													placeholder="Arwen" minlength="3" name="username" required />
												<label for="inputNombre">Nombre de usuario</label>
											</div>
											<div class="form-floating mb-3">
												<input class="form-control" id="inputPassword"
													type="password" placeholder="Contraseña" minlength="8"
		...
		<div id="carouselExampleCaptions" class="carousel slide carousel-fade"
			...
			<div class="carousel-inner">
				<div class="carousel-item active">
					<img src="/visitatierramedia/assets/img/TM-Fotos/eriador.jpg"
						class="d-block w-100 " alt="Imagen de eriador">
				...
				<div class="carousel-item">
					<img src="/visitatierramedia/assets/img/TM-Fotos/rohan.jpg"
						class="d-block w-100" alt="Imagen de rohan">
					<div class="carousel-caption justify-content-center">
						<div class="titulo" col-10 align-center>
							<h1>Descubre, vive, respira Tierra Media</h1>
							<div class="d-inline-flex p-2 bd-highlight">
				...
				<div class="carousel-item">
					<img src="/visitatierramedia/assets/img/TM-Fotos/mordor2.jpg"
						class="d-block w-100" alt="Imagen de mordor">
					<div class="carousel-caption justify-content-center">
						<div class="titulo" col-10 align-center>
							<h1>Descubre, vive, respira Tierra Media</h1>
							<div class="d-inline-flex p-2 bd-highlight">
	...
	<main class="mt-5">
		<div class="container">
			...
			<section class="seccion mx-auto my-md-5" id="destinos">
				<article>
					...
					<div class="row">
						<div
							class="col-12 col-lg-6 bg-image hover-overlay ripple shadow-2-strong"
							data-mdb-ripple-color="light">
							<img src="/visitatierramedia/assets/img/TM-Fotos/tmmap.jpg"
								alt="Mapa" class="img-fluid" /> <a href="#!">
								<div class="mask"></div>
							</a>
				...
				<div class="card-group ">
						...
						<div class="card cardInter ps-1 pe-1 pb-1">
							<div class="wrapper h-100 text-white">
								<img class="card-img-top h-100"
									src="/visitatierramedia/assets/img/TM-Fotos/lacomarca3.jpg"
									alt="Comarca">
								<div
									class="card-img-overlay titulo-actividades d-flex align-items-end">
					...
					<div class="col-12 col-md-4">
						<div class="card cardInter ps-1 pe-1 pb-1">
							<div class="wrapper h-100 text-white">
								<img class="card-img-top h-100"
									src="/visitatierramedia/assets/img/TM-Fotos/Belerian.jpg"
									alt="fotoPaisaje">
								<div
									class="card-img-overlay titulo-actividades d-flex align-items-end">
		...
		<section
			class=" seccion container mx-auto my-md-5 align-items-center justify-content-center  alto-75"
			id="experiencias">
			<h4 class="subtitulo text-center">Experiencias de turistas</h4>
			<section
				class="container d-flex align-items-center justify-content-center "></section>
			<div class="row">
							...
							<article class="card h-100 tarjetas-c1 shadow">
								<div class="card-body">
									...
									<div>
										...
										Tierra Media a vacacionar con mi familia y no podemos dejar de recomendar
										el lugar. Nos quedamos 20 días, pero se hicieron cortos... Volveremos!</p>
									</div>
								</div>
							</article>
						</div>
							...
							<article class="card h-100 tarjetas-c2 text-white shadow">
								<div class="card-body">
									...
									<div>
										...
										tuve la oportunidad. Es todo lo que esperaba y más! Disfrutamos mucho
										con mi pareja. Es muy amplio! Hay de todo! Estamos pensando en mudarnos 
										aquí.</p>
									</div>
								</div>
							</article>
				...
				<div class="col-12 col-lg-3 p-2">
					<article class="card h-100 tarjetas-c1 shadow">
						<div class="card-body">
							<div class="d-flex mb-3">
								<img src="/visitatierramedia/assets/img/profile/1.jpg" alt="fotoPerfil"
									class="imgPerfil border border-secundary 
                                border-3 rounded-circle">
								<div class="ps-3">

...
<!-- Navbar -->
<nav
	class="navbar navbar-expand-md navbar-color navbar-light fixed-top bgcolor"
	aria-label="Fourth navbar example">
	<div class="container">
		<a class="navbar-brand" href="/visitatierramedia/"> <img
			class="logo" src="/visitatierramedia/assets/img/logos/logoVTM.png"
			alt="" width=190px />
		</a>
			...
			<div class="btn-group">
				...
				<ul class="dropdown-menu dropdown-menu-end">
					<li><a class="dropdown-item "
						href="/visitatierramedia/purchased.do" aria-current="true"> <img
							class="pb-2 pe-1"
					...
					<li><a class="dropdown-item" href="/visitatierramedia/logout">
							<img class="pb-1 pe-1"

		...
		<div id="layoutSidenav_content"> 
			<main>
	          <div class="container-fluid px-4">
	            <h1 class="mt-4">Formulario editar usuario</h1>
	            <ol class="breadcrumb mb-4">
	              <li class="breadcrumb-item">
	                <a href="/visitatierramedia/admin/">Tablero</a>
	              </li>
	              <li class="breadcrumb-item">
	                <a href="/visitatierramedia/admin/users/edit.do">Editar</a>
	              </li>
	              <li class="breadcrumb-item active">Usuario</li>
	            </ol>
	            
	            <c:choose>
					<c:when test="${usuario != null && !usuario.isValid()}">
						<div class="alert alert-danger alert-dismissible">
							<button type="button" class="btn-close" data-bs-dismiss="alert"
									aria-label="Close"></button>
							<i class="fas fa-exclamation-triangle me-1"></i>
							<span>Se encontraron errores al actualizar el usuario.</span>
						</div>
					</c:when>
					<c:otherwise>
	            ...
	            <div class="card mb-4">
	              ...
	              <div class="card-body">
	                ...
	                <!--  Form -->
	                <form action="/visitatierramedia/admin/users/edit.do" method="post" class="needs-validation" novalidate>
	                  <input type="hidden" name="id" value="${usuario.id}">
	                  <jsp:include page="/admin/users/edit-form.jsp"></jsp:include>

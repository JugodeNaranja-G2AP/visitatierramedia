		...
		<div id="layoutSidenav_content"> 
			<main>
	          <div class="container-fluid px-4">
	            <h1 class="mt-4">Formulario editar atracción</h1>
	            <ol class="breadcrumb mb-4">
	              <li class="breadcrumb-item">
	                <a href="/visitatierramedia/admin/">Tablero</a>
	              </li>
	              <li class="breadcrumb-item">
	                <a href="/visitatierramedia/admin/attractions/edit.do">Editar</a>
	              </li>
	              <li class="breadcrumb-item active">Atraccion</li>
	            </ol>
	            <c:choose>
					<c:when test="${atraccion != null && !atraccion.isValid()}">
						<div class="alert alert-danger alert-dismissible">
							...
							<span>Se encontraron errores al actualizar la atracción.</span>
						</div>
					</c:when>
					<c:otherwise>
	            ...
	            <div class="card mb-4">
	              ...
	              <div class="card-body">
					...
					<!--  Form -->
	                <form action="/visitatierramedia/admin/attractions/edit.do" method="post" class="needs-validation" novalidate>
	                  <input type="hidden" name="id" value="${atraccion.id}">
	                  <jsp:include page="/admin/attractions/edit-form.jsp"></jsp:include>

<nav class="navbar navbar-expand-md navbar-dark bg-dark navbar-admin fixed-top">
	<div class="container">
		<!-- Navbar Brand-->
		<a class="navbar-brand ps-3" href="/visitatierramedia/admin/"> <img
				src="/visitatierramedia/assets/img/logos/logo_blanco.png" alt="logo-brand" width="190">
		</a>
		<!-- Sidebar Toggle-->
		<div class="navbar-nav ms-md-0">
